...
<div id="container">
  ...
  <div id="controls">
    ...
    <div class="control-section viewport-age">
      <a class="age-display" href="/all-ages-map">&raquo; Switch to All ages</a>
      <div style="display:none;">
        <input id="level-adult" type="radio" name="age" value="adult" checked><span class="label">Adults (50 years and older)</span><br>
      </div>
    </div>
    <div class="control-section last">
      ...
      <div class="key-container">
        ...
        <div class="key-label">0% - 3%</div>
        <div class="key level1"></div>
        <div class="key-label">3% - 8%</div>
        <div class="key level2"></div>
        <div class="key-label">8% - 11%</div>
        <div class="key level3"></div>
        <div class="key-label">11% - 15%</div>
        <div class="key level4"></div>
        <div class="key-label">15% - 19%</div>
        <div class="key level5"></div>
        <div class="key-label">19% - 22%</div>
        <div class="key level6"></div>
        <div class="key-label">22% - 26%</div>
        <div class="key level7"></div>
        <div class="key-label">26% - 30%</div>
        <div class="key level8"></div>
        <div class="key-label">30% - 35%</div>
        <div class="key level9"></div>
        <div class="key-label"> &gt; 50%</div>
